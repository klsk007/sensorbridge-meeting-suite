...
$iconPath = Join-Path $objDir 'SensorBridge.ico'
$exePath = Join-Path $outDir 'SensorBridge.App.exe'
...
function New-SensorBridgeIcon {
  param([string]$Path)
  Add-Type -AssemblyName System.Drawing
  $bitmap = New-Object System.Drawing.Bitmap 64, 64
  $graphics = [System.Drawing.Graphics]::FromImage($bitmap)
  $graphics.SmoothingMode = [System.Drawing.Drawing2D.SmoothingMode]::AntiAlias
  $graphics.Clear([System.Drawing.Color]::FromArgb(22, 95, 111))
  $brush = New-Object System.Drawing.Drawing2D.LinearGradientBrush(
    (New-Object System.Drawing.Rectangle 0, 0, 64, 64),
    [System.Drawing.Color]::FromArgb(44, 180, 155),
    [System.Drawing.Color]::FromArgb(15, 82, 122),
    45
  )
  ...
  $graphics.DrawString('SB', $font, [System.Drawing.Brushes]::White, (New-Object System.Drawing.RectangleF 0, 0, 64, 64), $format)
...
$report = [ordered]@{
  ok = $false
  command = 'build_sensorbridge_app'
...
if (-not $csc) {
  ...
  try {
    New-SensorBridgeIcon -Path $iconPath
...
if ($Json) {
  ...
  Write-Host "SensorBridge app built:"
  Write-Host "  $exePath"
} else {
  Write-Host "SensorBridge app build failed:"
